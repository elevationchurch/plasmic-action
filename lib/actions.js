...
class PlasmicAction {
    ...
    sync() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            yield exec_1.exec(`git checkout ../../pnpm-lock.yaml`, this.opts);
    ...
    commit(branch) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            yield exec_1.exec(`git config user.name '${this.args.gitUserName}'`, this.opts);
            yield exec_1.exec(`git config user.email '${this.args.gitUserEmail}'`, this.opts);
